...
|-------|-------|-------------|
| `core` | 234 | Pure core functionality (basic instructions, control flow, waveforms) |
...
| `error_validation` | 6 | Compiler error and warning validation |
