# TODO.md archive — Phases 43, 44, 45, 47–62 + Phase D/R/S Summary (archived 2026-05-08)

This file preserves the dense per-phase narrative for all phases that
were complete at the time of this archive sweep.  Every item below is
ticked; no open work was archived.

## Why archived

After Phase 62 (precompClear + UHFQA wave-mem) and the IF-200 fix +
Phase 44 IF-109 audit completed on 2026-05-08, every phase entry in
`TODO.md` had 0 unchecked items.  The file had grown to ~2040 lines
of pure historical record with no forward-looking work, which is
exactly what `reconstructed/notes/archive/` is for.
...
- **Phase 45** — Resolve all open IF items (housekeeping for IF-1, IF-4, IF-8, IF-9, etc.)
- **Phase 43** — Symbol-size divergence investigations (53 sub-items across 43.1/43.2/43.3)
- **Summary of remaining work** narrative — Phase D / R / S commit history (also summarized in OVERVIEW.md "Symbol Renames" tables)
- **Phase 44** — IF-109 bytes-vs-samples naming audit in wave-memory subsystem
- **Phase 47** — zivibes intake follow-ups (IF-155, IF-156, IF-157)
- **Phase 48** — Stress test suite + IF-158
- **Phase 49** — Stress suite expansion + IF-159
- **Phase 50** — Stress round 3 (IF-161, IF-162)
- **Phase 51** — Stress round 4 (IF-163)
- **Phase 52** — Stress round 5 (IFs 164–171)
- **Phase 53** — Stress round 6 (IFs 172–175)
- **Phase 54** — Stress round 7 (IFs 176–178)
- **Phase 55** — Stress round 8 (IF-179)
- **Phase 56** — Stress round 9 (IFs 180–181)
- **Phase 57** — Fix open IF backlog (IFs 158, 159, 161–181)
- **Phase 58** — Finish remaining difftests, 444/444 stress
- **Phase 59** — Stress round 10 + 4-device coverage
- **Phase 60** — Fix IF-192 (UHFQA missing program-size check)
- **Phase 61** — 4-device coverage backfill
- **Phase 62** — Round 11 (precompClear, prefetch-pressure, UHFQA wave-mem; IF-194..199 closed)
...
- `reconstructed/notes/archive/OVERVIEW_phases_13-25.md`
- `reconstructed/notes/archive/IF-105_update_log.md`

The Phase D / R / S commit tables in `OVERVIEW.md` "Symbol Renames"
