# Linker Resolution — Undefined Symbol Reference

**Original:** "Undefined Symbols Audit (Phase 19d)" — renamed 2026-04-24
to comply with AGENTS.md topic-naming convention.

**Status:** All 95 symbols resolved across Phases 20a-20e (see
work-package history in `notes/archive/` if needed). This file is
retained as long-lived technical reference for the symbol grouping,
per-class resolution patterns (sret, template inlining, inline-ctor),
and remaining open questions.

**Date:** 2026-04-23 (created), 2026-04-24 (WP-status tracking archived)
...
## 5. Resolution History (all complete — retained for reference)

Five work-packages, executed in order across Phases 20a-20e. **All
95 symbols resolved, build clean.** This section is retained as a
historical log of what was done and what patterns were used; it is NOT
