...
- [x] **Commit 15** — Cluster M (Assembler type recomposition; GDB+RTTI confirm first; partly structural).
 - [x] **Commit 16** — Open arbitrations (§2; one PR per arbitration; investigate-first items: 1, 2, 4, 5, 7, 9, 11; resolve approved items: 3 swap, 6 keep lhs/rhs, 8 cmdToken/argList).
...
- [x] **Commit 19** — Promote incidental bugs (§9; 7 IF-IDs added to `incidental_findings.md`). Promote type-suspicion observations (§8) to IF-IDs.
