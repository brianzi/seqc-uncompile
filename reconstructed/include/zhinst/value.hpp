...
//   +0x00  [24 bytes]  union storage (AddressImpl<uint> / int / std::string SSO)
//   +0x18  [4 bytes]   variant index:
//                         0 = AddressImpl<uint>
//                         1 = int
//                         2 = std::string
...
public:
    ...
    // --- Comparison ---
    bool operator==(Immediate other) const;  // 0x290d40 — vtable dispatch at b070e0
};
...
// ============================================================================
// Value — ValueType tag + boost::variant<int, bool, double, std::string>
//
// Layout (40 bytes, 0x28):
//   +0x00  [4 bytes]   ValueType type_   — outer tag (0..4)
//   +0x04  [4 bytes]   (padding)
//   +0x08  [4 bytes]   int32_t which_    — boost::variant discriminator
//                       Decoded: (which_ >> 31) ^ which_
