...
std::unique_ptr<NodeMap> GetNodeMap<AwgDeviceType::HDAWG>::get() {  // @0x1ad9a0
    ...
    addVirt(m, "oscs/0/freq", "OSCFREQ", {0}, 4, true, 0x00);
    addVirt(m, "oscs/1/freq", "OSCFREQ", {1}, 4, true, 0x08);
    addVirt(m, "oscs/10/freq", "OSCFREQ", {10}, 4, true, 0x50);
    addVirt(m, "oscs/11/freq", "OSCFREQ", {11}, 4, true, 0x58);
    addVirt(m, "oscs/12/freq", "OSCFREQ", {12}, 4, true, 0x60);
    addVirt(m, "oscs/13/freq", "OSCFREQ", {13}, 4, true, 0x68);
    addVirt(m, "oscs/14/freq", "OSCFREQ", {14}, 4, true, 0x70);
    addVirt(m, "oscs/15/freq", "OSCFREQ", {15}, 4, true, 0x78);
    addVirt(m, "oscs/2/freq", "OSCFREQ", {2}, 4, true, 0x10);
    addVirt(m, "oscs/3/freq", "OSCFREQ", {3}, 4, true, 0x18);
    addVirt(m, "oscs/4/freq", "OSCFREQ", {4}, 4, true, 0x20);
    addVirt(m, "oscs/5/freq", "OSCFREQ", {5}, 4, true, 0x28);
    addVirt(m, "oscs/6/freq", "OSCFREQ", {6}, 4, true, 0x30);
    addVirt(m, "oscs/7/freq", "OSCFREQ", {7}, 4, true, 0x38);
    addVirt(m, "oscs/8/freq", "OSCFREQ", {8}, 4, true, 0x40);
    addVirt(m, "oscs/9/freq", "OSCFREQ", {9}, 4, true, 0x48);
    addVirt(m, "oscs/phasereset", "OSCPHASERST", {}, 0, true, 0x88);
    ...
    addVirt(m, "sines/0/harmonic", "SINEHARM", {0}, 0, true, 0xa4);
    addVirt(m, "sines/0/oscselect", "SINEOSCSEL", {0}, 0, true, 0x9c);
    addVirt(m, "sines/0/phaseshift", "SINEPHASE", {0}, 5, true, 0xa0);
    ...
    addVirt(m, "sines/1/harmonic", "SINEHARM", {1}, 0, true, 0xb0);
    addVirt(m, "sines/1/oscselect", "SINEOSCSEL", {1}, 0, true, 0xa8);
    addVirt(m, "sines/1/phaseshift", "SINEPHASE", {1}, 5, true, 0xac);
    ...
    addVirt(m, "sines/2/harmonic", "SINEHARM", {2}, 0, true, 0xa4);
    addVirt(m, "sines/2/oscselect", "SINEOSCSEL", {2}, 0, true, 0x9c);
    addVirt(m, "sines/2/phaseshift", "SINEPHASE", {2}, 5, true, 0xa0);
    ...
    addVirt(m, "sines/3/harmonic", "SINEHARM", {3}, 0, true, 0xb0);
    addVirt(m, "sines/3/oscselect", "SINEOSCSEL", {3}, 0, true, 0xa8);
    addVirt(m, "sines/3/phaseshift", "SINEPHASE", {3}, 5, true, 0xac);
    ...
    addVirt(m, "sines/4/harmonic", "SINEHARM", {4}, 0, true, 0xa4);
    addVirt(m, "sines/4/oscselect", "SINEOSCSEL", {4}, 0, true, 0x9c);
    addVirt(m, "sines/4/phaseshift", "SINEPHASE", {4}, 5, true, 0xa0);
    ...
    addVirt(m, "sines/5/harmonic", "SINEHARM", {5}, 0, true, 0xb0);
    addVirt(m, "sines/5/oscselect", "SINEOSCSEL", {5}, 0, true, 0xa8);
    addVirt(m, "sines/5/phaseshift", "SINEPHASE", {5}, 5, true, 0xac);
    ...
    addVirt(m, "sines/6/harmonic", "SINEHARM", {6}, 0, true, 0xa4);
    addVirt(m, "sines/6/oscselect", "SINEOSCSEL", {6}, 0, true, 0x9c);
    addVirt(m, "sines/6/phaseshift", "SINEPHASE", {6}, 5, true, 0xa0);
    ...
    addVirt(m, "sines/7/harmonic", "SINEHARM", {7}, 0, true, 0xb0);
    addVirt(m, "sines/7/oscselect", "SINEOSCSEL", {7}, 0, true, 0xa8);
    addVirt(m, "sines/7/phaseshift", "SINEPHASE", {7}, 5, true, 0xac);
